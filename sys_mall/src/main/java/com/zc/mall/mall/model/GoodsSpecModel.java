 ...
 * @since 2018年11月13日
 */
public class GoodsSpecModel extends GoodsSpec {
    /**
     * 序列号
     **/
     ...
     * 实体转换model
     */
    public static GoodsSpecModel instance(GoodsSpec goodsSpec) {
        if (goodsSpec == null || goodsSpec.getId() <= 0) {
            return null;
        }
