 ...
 */
@Component
public class WithdrawFailExecuter extends BaseExecuter {
    ...
    public void addAccountLog() {
        AccountLog log = new AccountLogModel().instanceAccountLog(account, user, OrderNid.ORDER_NID_ACCOUNT_WITHDRAW_CASHFAIL.getNid(), null, money, model.getOrderNo(), null);
