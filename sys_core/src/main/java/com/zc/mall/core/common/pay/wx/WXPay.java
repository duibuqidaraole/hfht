...
import com.zc.mall.core.common.pay.wx.WXPayConstants.SignType;
...
public class WXPay {
    ...
    public Map<String, String> fillH5Data(Map<String, String> reqData, String prepay_id) throws Exception {
        reqData.put("appId", config.getAppID());
        reqData.put("timeStamp", DateUtil.getNowTimeStr());
